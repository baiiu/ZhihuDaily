...
public class NewsDetailActivity extends BaseActivity {
    ...
    private void loadData(String id) {
        DailyClient.getNewsDetail(volleyTag, id, new RequestCallBack<DailyDetail>() {
            @Override
            public void onSuccess(DailyDetail response) {
                collapsingToolbar.setTitle(response.title);
                ...
                webView.loadDataWithBaseURL("", HTMLUtil.handleHtml(response.body, true).toString(), "text/html", "utf-8", null);
            }
